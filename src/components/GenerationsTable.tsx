  ...
  if (generations.length === 0) {
    return (
      <div className="text-center py-12 text-muted-foreground">
        ...
        <p className="text-sm mt-2">Wygeneruj pierwsze fiszki, aby zobaczyć statystyki</p>
      </div>
    );
  }
      ...
      <Table>
        ...
        <TableBody>
          {generations.map((generation) => {
            ...
            const acceptedTotal = generation.accepted_unedited_count + generation.accepted_edited_count;
            ...
            return (
              <TableRow key={generation.id}>
                ...
                <TableCell>
                  <span className="text-sm font-mono text-muted-foreground">{generation.model}</span>
                </TableCell>
                <TableCell className="text-center">
                  <span className="text-sm font-medium">{generation.generated_count}</span>
                </TableCell>
                <TableCell className="text-center">
