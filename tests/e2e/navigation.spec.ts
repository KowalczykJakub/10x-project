...
test.describe('Application Navigation', () => {
  ...
  test('user can navigate between main pages', async ({ page }) => {
    ...
    const studyLink = page.locator(
      'a:has-text("Nauka"), a:has-text("Study"), a:has-text("Sesja")'
    ).first();
    ...
    const profileLink = page.locator(
      'a:has-text("Profil"), a:has-text("Profile")'
    ).first();
    ...
    const generateLink = page.locator(
      'a:has-text("Generuj"), a:has-text("Generate")'
    ).first();
  ...
  test('logo or home link navigates to main page', async ({ page }) => {
    ...
    const homeLink = page.locator(
      'a[href="/"], a[href="/generate"], img[alt*="logo"]'
    ).first();
...
test.describe('Unauthenticated Navigation', () => {
  ...
  test('user can navigate from login to register', async ({ page }) => {
    ...
    const registerLink = page.locator(
      'a:has-text("Zarejestruj"), a:has-text("Register"), a:has-text("Sign up")'
    );
  ...
  test('user can navigate from register to login', async ({ page }) => {
    ...
    const loginLink = page.locator(
      'a:has-text("Zaloguj"), a:has-text("Login"), a:has-text("Sign in")'
    );
